...
AudioFrame * AudioBuffer::getAudioFrame(pmTimeDiff time){
...
pmTimestamp AudioBuffer::getLastTimestamp(){
    if(size()>0)
...
pmTimeDiff AudioBuffer::getTotalTime(){
    return getLastTimestamp()-getInitTime();
}
pmTimestamp AudioBuffer::getInitTime(){
    return initTime;
}
